...
public class OnTheFlyCommands {
  ...
  private enum OnTheFlyTargetPose {
    ...
    TWO_LEFT(5.1, 2.82, 120),
    FOUR_LEFT(3.76, 2.98, 60),
    SIX_LEFT(3.2, 4.2, 0),
    EIGHT_LEFT(4.0, 5.2, -60),
    TEN_LEFT(5.2, 5.0, -120),
    TWELVE_LEFT(5.84, 3.76, 180),
    TWO_RIGHT(5.22, 3.0, 120),
    FOUR_RIGHT(3.96, 2.78, 60),
    SIX_RIGHT(3.2, 3.86, 0),
    EIGHT_RIGHT(3.68, 5.01, -60),
    TEN_RIGHT(5.16, 5.16, -120),
    TWELVE_RIGHT(5.84, 4.2, 180),
