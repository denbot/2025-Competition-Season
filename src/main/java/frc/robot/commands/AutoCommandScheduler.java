...
/**
 * Specific Command Scheduler for auto alignment sequences.
 * Pathplanner OTF commands call commands in their execute and finish before the command they initialized finishes.
 * Due to this, the default Sequential Command Group runs into scheduling conflicts and does not work.
 */
public class AutoCommandScheduler {
  ...
  /**
   * Function to itterate over all targetChange commands passed into the auto alignment.
   * Also calls an OTF command in order to cary out said alignment
   */
