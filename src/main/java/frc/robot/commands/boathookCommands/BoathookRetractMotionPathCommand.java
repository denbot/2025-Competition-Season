  ...
  public BoathookRetractMotionPathCommand(Boathook boathook) {
    ...
    addCommands(
        new setBoathookStateCommand(
            boathook, boathookAngle.noChangeAngle, boathookLength.setupLength),
        new setBoathookStateCommand(
            boathook, boathookAngle.scoreAngle, boathookLength.noChangeLength),
        new setBoathookStateCommand(
            boathook, boathookAngle.noChangeAngle, boathookLength.scoreLength),
        new setBoathookStateCommand(
            boathook, boathookAngle.idleAngle, boathookLength.noChangeLength),
        new setBoathookStateCommand(
            boathook, boathookAngle.noChangeAngle, boathookLength.idleLength));
  }
}
