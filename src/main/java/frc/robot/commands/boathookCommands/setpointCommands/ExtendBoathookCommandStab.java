...
public class ExtendBoathookCommandStab extends Command {
  /** Creates a new ExtendBoathookCommand. */
  Boathook boathook;

  public ExtendBoathookCommandStab(Boathook boathook) {
  ...
  @Override
  public void execute() {
    boathook.setLength(Constants.BoathookConstants.STAB_EXTENSION);
    System.out.println(
        "extending length: "
            + boathook.getLength()
            + " and extending to: "
            + BoathookConstants.STAB_EXTENSION);
  }
